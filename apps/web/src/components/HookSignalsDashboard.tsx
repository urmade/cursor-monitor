...
import type { HookSignalEvent, HookSignalsTree } from '../server/hook-signals';
...
function formatCents(cents: number | null | undefined): string {
  ...
  return `$${(cents / 100).toFixed(4)} (${cents}¢)`;
}
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-fg-muted">
        ...
        conversation · expand a turn for the full log entry
      </p>
                      ...
                      <summary className="cursor-pointer list-none px-3 py-2 [&::-webkit-details-marker]:hidden">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {conv.chargedCentsTotal != null ? (
                            <Badge tone="info">
                              {formatCents(conv.chargedCentsTotal)}
                            </Badge>
                          ) : null}
